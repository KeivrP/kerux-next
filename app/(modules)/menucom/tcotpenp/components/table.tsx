...
import { Acciones, columnsFilter, columnsHeadersTcotpenp, columnsOrder } from "./header-table";
...
export const Tcotpenp = () => {
  ...
  const [order, setOrder] = useState<Order[]>([
    {operator: "DESC", column: "numcot", id: "numcot"}, 
  ]);
    ...
    <>
      ...
      >
        <BaseTable
          loading={isLoading}
          rows={rows}
          headers={columnsHeadersTcotpenp }
