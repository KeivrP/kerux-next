...
export const TmodscTable = () => {
  ...
  const [order, setOrder] = useState<Order[]>([
    { column: "nrosc", id: "nrosc", operator: "DESC" },
  ]);
  ...
  const handleOpenFSolComp = (row: ITSolRec) => {
    router.push(`${pathname}/${row.nrosc}`);
  };
        ...
        <BaseTable
          ...
          collapsible={{
            visible: (row) => [
              ...
              {
                content: <Acciones row={row} onFile={handleOpenFSolComp} />,
                action: () => null,
                disableTooltip: true,
              },
            ],
