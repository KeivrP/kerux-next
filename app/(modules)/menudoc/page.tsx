...
export default function Home() {
    ...
    return (
        <div className={`flex items-center justify-center h-screen bg-gradient-to-r from-blue-400 to-purple-600 transition-opacity duration-500 ${fade ? 'opacity-100' : 'opacity-0'}`}>
            <div className="text-center bg-white rounded-lg shadow-lg p-8 transform transition-transform duration-500 hover:scale-105">
                ...
                <a href="/documentos" className="inline-block px-6 py-3 bg-blue-500 text-white rounded-lg shadow hover:bg-blue-600 transition duration-200 transform hover:scale-105">
                    Comenzar
                </a>
            </div>
        </div>
