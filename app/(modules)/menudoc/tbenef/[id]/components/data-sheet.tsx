...
import { Card, CardContent, CardHeader, Typography, Grid2 as Grid, Box, TextField, FormControlLabel, Checkbox, FormControl, FormLabel, RadioGroup, Radio, Select, MenuItem } from "@mui/material";
...
export default function DataSheet({
    ...
    const { control, handleSubmit, reset } = useForm<BeneficiaryData>()
                                    ...
                                    <Grid size={{ xs: 12, md: 4 }}>
                                        <FormControl component="fieldset">
                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <RadioGroup {...field}>
                                                        <FormControlLabel value="P" control={<Radio size="small" />} label="Público" />
                                                        <FormControlLabel value="N" control={<Radio size="small" />} label="Natural" />
                                                        <FormControlLabel value="J" control={<Radio size="small" />} label="Jurídico" />
                                                        <FormControlLabel value="E" control={<Radio size="small" />} label="Extranjero" />
                                                    </RadioGroup>
                                                )}
                                            />
                                        </FormControl>
                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <RadioGroup {...field} row>
                                                        <Grid container>
                                                            <Grid size={6}>
                                                                <FormControlLabel value="F" control={<Radio size="small" />} label="Funcionario" />
                                                            </Grid>
                                                            <Grid size={6}>
                                                                <FormControlLabel value="P" control={<Radio size="small" />} label="Proveedor" />
                                                            </Grid>
                                                            <Grid size={6}>
                                                                <FormControlLabel
                                                                    value="S"
                                                                    control={<Radio size="small" />}
                                                                    label="Socio Beneficiario"
                                                                />
                                                            </Grid>
                                                            <Grid size={6}>
                                                                <FormControlLabel value="O" control={<Radio size="small" />} label="Obrero" />
                                                            </Grid>
                                                            <Grid size={6}>
                                                                <FormControlLabel
                                                                    value="A"
                                                                    control={<Radio size="small" />}
                                                                    label="Organismo adscrito"
                                                                />
                                                            </Grid>
                                                            <Grid size={6}>
                                                                <FormControlLabel value="C" control={<Radio size="small" />} label="Cuentadante" />
                                                            </Grid>
                                                        </Grid>
                                                    </RadioGroup>
                                                )}
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            <Grid size={{ xs: 12, sm: 4 }}>
                                                ...
                                                <Controller
                                                    ...
                                                    control={control}
                                                    render={({ field }) => (
                                                        <Select {...field} size="small" fullWidth sx={{ backgroundColor: "white" }}>
