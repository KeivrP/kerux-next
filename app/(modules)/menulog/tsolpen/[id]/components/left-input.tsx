        ...
        <Grid container spacing={1} mt={1}>
          <Grid size={3}>
            <ConditionalWrapper condition={isLoading} wrapper={SkeletonInput}>
              <Input disabled value={formData.cabsolsum.idsolsum} />
            </ConditionalWrapper>
          </Grid>
          <Grid size={9}>
            <ConditionalWrapper condition={isLoading} wrapper={SkeletonInput}>
        ...
        <Grid container spacing={1} mt={1}>
          ...
          <Grid size={{ lg: 8, xl: 9, md: 6 }}>
            <ConditionalWrapper
              ...
              wrapper={SkeletonInput}
            >
              <Input disabled value={Dependencia}  />
            </ConditionalWrapper>
          </Grid>
        </Grid>
      </Grid>
        ...
        <Grid container spacing={1} mt={1}>
          ...
          <Grid size={{ lg: 8, xl: 9, md: 6 }}>
            <ConditionalWrapper
              ...
              wrapper={SkeletonInput}
            >
              <Input disabled value={CodAccionInt}  />
            </ConditionalWrapper>
          </Grid>
        </Grid>
      </Grid>
