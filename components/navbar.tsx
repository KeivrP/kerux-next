        ...
        return (
          ...
          >
            <g clipPath="url(#prefix__clip0_603_18715)">
              <rect width={30} height={30} rx={3} fill="#3F9A43" />
              <rect
                width={30}
                height={30}
                rx={3}
  ...
  return (
    <>
      <aside className="fixed top-0 left-0 z-50 flex">
        <div className="flex flex-col items-center w-16 h-screen py-8 space-y-8 bg-[#142F62] py-8 dark:bg-gray-900 dark:border-gray-700 z-50">

          <a href="#" className=" text-gray-500 transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
          ...
          {menus.map((item, i) => (
            <a key={i} href="#" className=" text-gray-500 transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
              {getMenuIcon(item.codmenu!)}
            </a>
