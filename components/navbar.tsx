        ...
        <aside className="fixed top-0 left-0 z-50 flex">
          <div
            className={`transition-all duration-300 ${
              open ? "w-72" : "w-24"
            } xl:p-4 p-2 bg-[#142f62] flex-col justify-start items-${
              open ? "start" : "center"
            } gap-5 inline-flex border-r bg-red border-r h-screen`}
          >
            {firstPathSegment === "" ? (
              <></>
            ) : (
              <>
                      ...
                      <div className="items-center flex ml-1">
                        ...
                        {open && (
                          <div className="flex-col inline-flex ml-2.5">
                            <h2 className="transition-all duration-300 text-gray-700 text-sm font-semibold leading-snug text-white">
                ...
                <div className="w-full">
                  <div className="w-full h-8 px-3 items-center flex">
                    <h6 className="text-gray-500 text-xs font-semibold leading-4 text-white">
                      MENU
                    </h6>
                  </div>
                  {submenu.map((item, i) => (
